<?php
    ...
    try{
        $pdo = new PDO("mysql:host=$host;dbname=$dbname;charset=utf8", $user, $pass);
        $stmt = $pdo->prepare(" SELECT * FROM getree_elementos WHERE academia_id = ?");
